  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="prose prose-gray max-w-none">
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-semibold text-foreground">3. Product Information</h2>
          <div className="space-y-4 text-muted-foreground">
            <p>
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-semibold text-foreground">4. Orders and Payment</h2>
          <div className="space-y-4 text-muted-foreground">
            <h3 className="text-xl font-medium text-foreground">Order Acceptance</h3>
            <p>
            ...
            <h3 className="mt-6 text-xl font-medium text-foreground">Payment Terms</h3>
            <ul className="list-disc space-y-2 pl-6">
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-semibold text-foreground">5. Shipping and Delivery</h2>
          <div className="space-y-4 text-muted-foreground">
            <p>
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-semibold text-foreground">6. Returns and Refunds</h2>
          <div className="space-y-4 text-muted-foreground">
            <p>
              Please see our{' '}
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-semibold text-foreground">7. User Accounts</h2>
          <div className="space-y-4 text-muted-foreground">
            <p>
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-semibold text-foreground">8. Prohibited Uses</h2>
          <div className="space-y-4 text-muted-foreground">
