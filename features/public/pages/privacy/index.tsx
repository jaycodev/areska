      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <h3 className="mt-6 text-xl font-medium">Automatically Collected Information</h3>
            <p>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <p>
              ...
              <span className="font-medium">privacy@store.com</span> or use the contact information
              provided below.
            </p>
          </div>
        </section>
