    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="prose prose-gray max-w-none">
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-semibold">Shipping Options</h2>
        ...
        <section className="mb-8">
          ...
          <div className="rounded-lg border bg-card p-6">
            <h3 className="mb-3 text-lg font-semibold">🚚 Free Standard Shipping</h3>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <h3 className="text-xl font-medium">Important Notes:</h3>
            ...
            <div className="rounded-lg border bg-card p-4">
              <h3 className="mb-2 font-semibold">💡 International Customers</h3>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <div className="rounded-lg bg-card p-6">
              <h3 className="mb-3 font-semibold">Tracking Information Includes:</h3>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4 text-muted-foreground">
            <h3 className="text-xl font-medium">Delivery Requirements:</h3>
            <ul className="list-disc space-y-2 pl-6">
            ...
            <h3 className="mt-6 text-xl font-medium">Delivery Issues:</h3>
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-semibold">Special Shipping Services</h2>
          <div className="space-y-4 text-muted-foreground">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="rounded-lg border p-6">
                <h3 className="mb-3 text-lg font-semibold">White Glove Delivery</h3>
              ...
              <div className="rounded-lg border p-6">
                <h3 className="mb-3 text-lg font-semibold">Hold for Pickup</h3>
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-semibold">Shipping Restrictions</h2>
          <div className="space-y-4 text-muted-foreground">
            <p>Please note the following shipping restrictions:</p>
            <div className="rounded-lg border bg-card p-4">
              <h3 className="mb-3 font-semibold">Restricted Areas</h3>
              <ul className="space-y-2 text-muted-foreground">
            ...
            <div className="mt-4 rounded-lg border bg-card p-4">
              <h3 className="mb-3 font-semibold">Product Restrictions</h3>
              <ul className="space-y-2 text-muted-foreground">
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-semibold">Contact Shipping Support</h2>
          <div className="space-y-4 text-muted-foreground">
